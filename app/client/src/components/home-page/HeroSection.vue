...
<template>
  ...
  <section
    id="hero"
    class="relative z-10 flex min-h-[90vh] flex-col justify-center gap-8 px-4 py-12 text-center sm:px-6 md:min-h-[75vh] md:flex-row md:gap-12 md:py-0 md:text-left"
  >
    <!-- Gradient glow background -->
    <div
      alt="Abstract space baground with stars and Brady Shea’s name overlay"
      class="absolute -inset-8 rounded-full bg-linear-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl"
    ></div>
    ...
    <div class="relative flex flex-col items-center gap-8 md:flex-row">
      ...
      <div
        ...
        class="flex shrink-0 justify-center md:-translate-y-2.5"
      >
        <div
          class="rounded-full bg-linear-to-r from-blue-500 via-cyan-500 to-purple-500 p-1 transition-all duration-300"
        >
          <Avatar
      ...
      <div
        ...
        data-aos-delay="400"
        class="hidden h-32 w-0.5 origin-top bg-linear-to-b from-blue-500 via-purple-500 to-pink-500 sm:h-40 md:block md:h-44"
      ></div>
        ...
        <div class="mt-6 flex flex-wrap justify-center gap-4 md:justify-start">
          <RouterLink to="/experience#portfolio">
            <Button
              ...
              class="rounded-full bg-linear-to-r from-blue-500 to-purple-500 px-6 py-3 font-medium text-white shadow-md transition hover:scale-[105%] hover:shadow-[0_0_10px_rgba(139,92,246,0.6)]"
            >
              View Projects
            </Button>
          </RouterLink>
    ...
    <div class="custom-shape-divider-bottom-1757396282">
      <svg
        data-name="Layer 1"
...
<style lang="css">
.custom-shape-divider-bottom-1757396282 {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
.custom-shape-divider-bottom-1757396282 svg {
  position: relative;
  display: block;
...
.custom-shape-divider-bottom-1757396282 .shape-fill {
