...
<template>
  ...
  <div
    ...
    data-aos-once="true"
    class="relative h-full animate-[gradient_6s_ease_infinite] bg-size-[200%_200%] p-0.5"
  >
    <div
      v-if="props.scaleMode === 'outer'"
      class="relative h-full overflow-visible rounded-2xl bg-linear-to-r from-blue-500 via-cyan-500 to-purple-500 bg-size-[200%_200%] p-0.5 transition-transform duration-300"
      :class="[
    ...
    <div
      v-else
      class="relative overflow-visible rounded-2xl bg-linear-to-r from-blue-500 via-cyan-500 to-purple-500 bg-size-[200%_200%] p-0.5"
      :class="[
        `[animation:gradient_${props.gradientSpeed || '12s'}_ease_infinite]`,
      ]"
    >
